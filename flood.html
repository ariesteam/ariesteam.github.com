...
<div style="height:30px;border:0px solid red">
  <h2 style="float:left;margin-right:15px;border:0px solid black">Flood regulation</h2>
  <button type="button" onclick="window.location='floodspecs.html'" style="margin-top:3px">Detailed module information</button>
</div>
<h3 style="text-align:justify;margin:10px 0px;border:0px solid green">
  ...
  flood. Human land use and development, as well as climate change,
  are transforming the "playing field" of flood protection. Decisions
  on flood protection have generally been based on hydrological
  modeling which provides a best guess at decade, 100, or 500 year
  flood levels. The topography, vegetation, soils, hydrology, flood
  creating rain events, impermeable surfaces, levees, dams, locations
  of farms, residents, businesses, and public infrastructure are all
  important factors in flooding, safety, and flood protection.
</h3>
<div style="width:500px;margin-right:15px;float:left">
  ...
  <div style="height:210px; border:0px solid black">
    ...
    <img src="images/chehalis.jpg" class="roundedImage" height="111" width="160" style="margin:0px 10px 50px 0px;float:left">
    <p style="text-align:left">
      In May 2010, <a href="http://www.eartheconomics.org">Earth
      Economics</a> completed a comprehensive Ecosystem Service and
      ...
      <br />
      <a href="westernwa.html"><img src="images/learn.gif" style="margin-top:10px" /></a>
    </p>
  </div>
  <div style="height:240px; border:0px solid black">
    <h4 style="color:#6699FF;text-align:left">West Coyote Hills, California</h4>
    <img src="images/CoyoteHillsCarbonUptake.jpg" class="roundedImage" height="111" width="160" style="margin:0px 10px 80px 0px;float:left">
    <p style="text-align:left">
...
<div style="height:480px;border:0px solid black">
  ...
  <p style="margin-bottom:15px">
    <strong>Flood regulation and its beneficiaries:</strong> ARIES
  ...
  <p style="margin-bottom:15px">
    <strong>Event-based modeling:</strong> ARIES currently models
