...
| <span />            | Coral reef bleaching                                              | UNEP-WCMC and ReefBase                                              | Global         | Vector polygon data          | 2003      |
| <span />            | Mangroves                                                         | FTM (Madagascar National Mapping Agency)                            | Madagascar     | Vector polygon data          | Mid-1990s |
| <span />            | Seagrass                                                          | UNEP-WCMC                                                           | Global         | Vector polygon data          | 2005      |
| <span />            | Terrestrial vegetation type                                       | FTM (Madagascar National Mapping Agency)                            | Madagascar     | Vector polygon data          | Mid-1990s |
|---------------------+-------------------------------------------------------------------+---------------------------------------------------------------------+----------------+------------------------------+-----------|
